...
function DashboardHeader() {
  ...
  const menuList = [
    ...
    { id: 6, name: "Calculators", icon: Calculator, path: "/dashboard/debts" },
    { id: 7, name: "AI Advisor", icon: FilePen, path: "/dashboard/ai-advisor" },
  ...
  return (
    <div className="p-3 shadow-sm border-b flex justify-between items-center relative bg-white dark:bg-gray-900 dark:text-white transition-all">
      ...
      <div className="absolute left-1/2 transform -translate-x-1/2 sm:block md:hidden">
        <Image src={"./chart-donut.svg"} alt="logo" width={30} height={25} />
        <span className="text-blue-800 dark:text-blue-400 font-bold text-xl">Finance360</span>
      </div>
